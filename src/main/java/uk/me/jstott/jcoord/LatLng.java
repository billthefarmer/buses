...
public class LatLng
{
    ...
    /**
     * Create a new LatLng object to represent a latitude/longitude
     * pair.
     *
     * @param lat
    ...
    /**
     * Convert this latitude and longitude into an OSGB (Ordnance
     * Survey of Great Britain) grid reference.
     *
    ...
    /**
     * Convert this LatLng from the OSGB36 datum to the WGS84 datum
    ...
    /**
     * Convert this LatLng from the WGS84 datum to the OSGB36 datum
     * using an approximate Helmert transformation.
     *
     * @since 1.0
     */
    ...
    /**
     * Calculate the surface distance in kilometres from the this
     * LatLng to the given LatLng.
     *
     * @param ll
