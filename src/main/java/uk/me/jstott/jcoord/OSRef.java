...
public class OSRef
{
    ...
    /**
     * Take a string formatted as a six-figure OS grid reference
     * (e.g. "TG514131") and create a new OSRef object that represents
     * that grid reference. The first character must be H, N, S, O or
     * T. The second character can be any uppercase character from A
     * through Z excluding I.
     *
     * @param ref
     *          a String representing a six-figure Ordnance Survey
     *          grid reference in the form XY123456
    ...
    /**
     * Return a String representation of this OSGB grid reference
     * showing the easting and northing.
     *
    ...
    /**
     * Return a String representation of this OSGB grid reference
     * using the six-figure notation in the form XY123456
     *
     * @return a String representing this OSGB grid reference in
     *         six-figure notation
     * @since 1.0
     */
    ...
    /**
     * Convert this OSGB grid reference to a latitude/longitude pair
     * using the OSGB36 datum. Note that, the LatLng object may need
     * to be converted to the WGS84 datum depending on the
     * application.
     *
     * @return a LatLng object representing this OSGB grid reference
