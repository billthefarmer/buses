...
public class Test
{
    ...
    public static void main(String[] args)
    {
         ...
         *
         * The distance() function takes a reference to a LatLng
         * object as a parameter and calculates the surface distance
         * between the the given object and this object in kilometres:
         */
         ...
         *
         * Note that the OSGB-Latitude/Longitude conversions use the
         * OSGB36 datum by default. The majority of applications use
         * the WGS84 datum, for which the appropriate conversions need
         * to be added. See the examples below to see the difference
         * between the two data.
         */

        System.out.println("Convert OS Grid Reference to Latitude/Longitude");
        // Using OSGB36 (convert an OSGB grid reference to a latitude
        // and longitude using the OSGB36 datum):
        ...
        // Using WGS84 (convert an OSGB grid reference to a latitude
        ...
        // Using OSGB36 (convert a latitude and longitude using the
        // OSGB36 datum to an OSGB grid reference):
        System.out.println("Using OSGB36");
        ...
        // Using WGS84 (convert a latitude and longitude using the
        // WGS84 datum to an OSGB grid reference):
        System.out.println("Using WGS84");
